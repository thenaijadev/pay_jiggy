...
class PreviewElectricityBillTransactionScreen extends StatelessWidget {
  const PreviewElectricityBillTransactionScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Image.asset(
          "assets/images/electricity_companies.png",
          height: 55,
        ),
      ),
      body: SafeArea(
